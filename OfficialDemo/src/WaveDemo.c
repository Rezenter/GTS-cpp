...
*  Default config file is "WaveDemoConfig.txt"
******************************************************************************/

#define WaveDemo_Release        "1.2.0"
#define WaveDemo_Release_Date   "20220310"
...
void StartAcquisition(WaveDemoConfig_t *WDcfg) {
	...
	strftime(WDrun.DataTimeFilename, 32, "%Y-%j_%H%M%S", tm_info);
}
